...
$Id: PtwMI.py,v 0.1 2004/06/29 22:00:00 dcavar Exp $
...
from stattools import sortNgrams, puncTrim, getLRBigrams, getBigrams, getTokens, getWordList
		...
		for x in glob.glob(os.path.normcase(i)):
			try:
				...
				for i in file.readlines():
					...
					bigramsleft, bigramsright = getLRBigrams(wordlist, bigramsleft, bigramsright)
				file.close()
			except IOError:
				file.close()
