...
Directing the [AI &amp; NLP Lab](https://ai-science-labs.org/) and the [Quantum AI Lab](https://quantum-computing-lab.org/).
...
- The weekly [AI &amp; NLP Lab](https://ai-science-labs.org/) meetings continue during Summer 2025: Details about meeting times and location can be found on the [website](https://ai-science-labs.org/). (This is not an open course, student, study, or reading group, this is just my lab meeting!)
...
- [Quantum AI and NLP Conference 2025](https://qnlp.ai/) at Indiana University in August 2025.
...
- Damir Cavar, [Ludovic V. Mompelat], [Muhammad S. Abdo] (2024) The Typology of Ellipsis: A Corpus for Linguistic Analysis and Machine Learning Applications. Paper presented at the [ACL Special Interest Group on Typology](https://sigtyp.github.io/) ([SIGTYP](https://sigtyp.github.io/)) 2024, colocated with the [18th Conference of the European Chapter of the Association for Computational Linguistics](https://2024.eacl.org/), St Julian's, Malta. ([full paper](https://aclanthology.org/2024.sigtyp-1.6/))
...
- Cavar, D., Koushik Reddy Parukola, Shane Sparks (2025) Old Wine in New Bottles: Using Classical Word Embeddings in Quantum NLP Systems. Paper presented at the [Midwest Speech and Language Days 2025](https://nlp.nd.edu/msld25/), University of Notre Dame, April 2025.
...
- **[AI &amp; NLP Lab](https://ai-science-labs.org/)** - research lab: see public calendar for location and meeting times (contact me, if you would like to join the lab)
...
- [AI &amp; NLP Lab](https://ai-science-labs.org/) - Drug discovery, neuro-symbolic modeling, AI for Science (Fridays 4 PM, Luddy 0002)
